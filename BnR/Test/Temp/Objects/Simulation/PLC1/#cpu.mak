...
export AS_CPU_PATH_2 := C:/projects/test/Temp//Objects/$(AS_CONFIGURATION)/$(AS_PLC)
export AS_ACTIVE_CONFIG_PATH := $(AS_PROJECT_PATH)/Physical/$(AS_CONFIGURATION)/$(AS_PLC)
export AS_STATIC_ARCHIVES_PATH := C:/projects/test/Temp//Archives/$(AS_CONFIGURATION)/$(AS_PLC)
